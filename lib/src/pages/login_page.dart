...
import 'package:pacto_movil/src/utils/utils.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Stack(
      children: <Widget>[_crearFonddo(context), _loginForm(context)],
    ));
  }

  Widget _crearFonddo(BuildContext context) {
  ...
  _login(LoginBloc bloc, BuildContext context) async {
    ...
    final userBloc = Provider.userGlobal(context);

    if (info['ok']) {
      userBloc.cargarUsuario(bloc.email, info['token']);
